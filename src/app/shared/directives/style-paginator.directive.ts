...
export class StylePaginatorDirective {
  private _pageGapTxt = "...";
  @Input() _rangeStart: number;
  @Input() _rangeEnd: number;
  private _buttons = [];
  @Input() _curPageObj: PageObject = {
    length: 0,
    pageIndex: 0,
    pageSize: 0,
    previousPageIndex: 0
        ...
        for (let i = 0; i < nodeArray.length; i++) {
          if (nodeArray[i].nodeName === "BUTTON") {
            if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
              ...
              this.ren.setStyle(nodeArray[i], "display", "none"); 
            } else if (
  ...
  private createButton(i: any, pageIndex: number): any {
    ...
    this.ren.setStyle(linkBtn, "border-radius", "10px");
    this.ren.setStyle(linkBtn, "margin-left", "15px");
    ...
    switch (i) {
      case pageIndex:
        ...
        this.ren.setStyle(linkBtn, "background-color", "#7B8EC8");
      ...
      default:
        ...
        this.ren.setStyle(linkBtn, "background-color", "#EEF4F8");
        this.ren.setStyle(linkBtn, "color", "#111111"); 
        break;
    }
